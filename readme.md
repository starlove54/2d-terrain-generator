This project is a 2D terrain generator that uses perlin noise to create natural-looking landscapes in real-time. The generator is built using the p5.js library and runs in the browser.
